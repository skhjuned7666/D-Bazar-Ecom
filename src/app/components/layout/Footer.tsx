      ...
      <div className='container mx-auto px-4'>
        <div className='grid grid-cols-2 md:grid-cols-5 gap-8 mb-8'>
          <div className='col-span-2'>
            <h2 className='text-2xl font-bold mb-4 text-white'>ShopKart</h2>
            <p className='text-gray-300 mb-4'>
              India's leading online shopping destination. Shop the latest
              trends with our premium e-commerce experience.
            </p>
